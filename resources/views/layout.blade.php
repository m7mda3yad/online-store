...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('homes/style.css') }}" rel="stylesheet" />
        @livewireStyles
    </head>
    <body>
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#">{{ auth()->guard('customer')->user()->name??'' }}</a></li>
                        <form action="{{route('logout')}}" method="post">
                            @csrf
                        <button class="btn-danger ml-3">Logout</button>
                        </form>                            @else
